...
function TalentsPage() {
	...
	const handleDelete = (id) => {
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				dispatch(setNotif(true, "success", `berhasil hapus speaker ${res.data.data.name}`));
				dispatch(fetchTalents());
			}
		});
	};
	...
	return (
		<Container className="mt-3">
			...
			<SearchInput query={talents.keyword} handleChange={(e) => dispatch(setKeyword(e.target.value))} />
